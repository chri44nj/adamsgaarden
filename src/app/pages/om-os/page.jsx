      ...
      <section className={styles.contact}>
        ...
        <div className={styles.flexRow}>
          <div className="flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ff5555" class="bi bi-telephone-fill" viewBox="0 0 16 16">
          ...
          <a className={`${styles.link} flex-row`} target="_blank" href="mailto:mail@adamsgaarden.dk">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffbb33" class="bi bi-envelope-fill" viewBox="0 0 16 16">
